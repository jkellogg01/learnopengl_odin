...
vec3 calc_spot_light(Spot_Light light, vec3 normal, vec3 fragment_position, vec3 view_direction);
...
void main() {
	...
	result += calc_spot_light(spot_light, fragment_normal, fragment_position, view_direction);
